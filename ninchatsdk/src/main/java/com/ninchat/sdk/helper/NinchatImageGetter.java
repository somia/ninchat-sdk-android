...
public class NinchatImageGetter implements Html.ImageGetter {
    private WeakReference<TextView> container;
    private boolean matchParentWidth;
    private HtmlImagesHandler imagesHandler;
    private float density = 1.0f;

    public NinchatImageGetter(TextView textView) {
        this(textView, false, false, null);
    }

    public NinchatImageGetter(TextView textView, boolean matchParentWidth, HtmlImagesHandler imagesHandler) {
        this(textView, matchParentWidth, false, imagesHandler);
    }

    public NinchatImageGetter(TextView textView, boolean matchParentWidth, boolean densityAware,
