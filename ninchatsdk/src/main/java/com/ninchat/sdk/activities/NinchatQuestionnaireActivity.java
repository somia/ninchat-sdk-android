...
public final class NinchatQuestionnaireActivity extends NinchatBaseActivity {
    ...
    private void createFormLikeQuestionnaire() {
        ...
        final int spaceInPixelTop = getResources().getDimensionPixelSize(R.dimen.ninchat_items_margin_top);
        final int spaceLeft = getResources().getDimensionPixelSize(R.dimen.ninchat_items_margin_left);
        final int spaceRight = getResources().getDimensionPixelSize(R.dimen.ninchat_items_margin_right);
